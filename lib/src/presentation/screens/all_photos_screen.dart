...
import 'package:photographers_reference_app/src/presentation/widgets/app_drop_target.dart'; // добавили
...
class _AllPhotosScreenState extends State<AllPhotosScreen> {
  ...
  Widget build(BuildContext context) {
    return AppDropTarget( // <-- оборачиваем ВСЮ страницу в AppDropTarget
